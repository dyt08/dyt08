...
- Currently learning about data engineer, previously learning about data science & machine learning
- <s>Looking for job opportunities that perform data processing (junior/middle data engineer)</s>
